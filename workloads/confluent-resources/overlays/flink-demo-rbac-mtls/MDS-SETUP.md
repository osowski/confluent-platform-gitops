# MDS/RBAC Setup Guide for flink-demo-rbac-mtls

This guide explains the MDS (Metadata Service) and RBAC configuration for the flink-demo-rbac-mtls cluster.

## Overview

The flink-demo-rbac-mtls cluster is configured with full RBAC authorization using:
...
TOKEN=$(curl -X POST http://keycloak.flink-demo-rbac-mtls.confluentdemo.local:30080/realms/confluent/protocol/openid-connect/token \
